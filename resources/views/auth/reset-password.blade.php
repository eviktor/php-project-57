<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('reset.email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('reset.password')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('reset.confirm')" />
